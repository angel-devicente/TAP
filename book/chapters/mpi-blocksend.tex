...
%
\begin{figure}[ht]
  \includegraphics[scale=.3]{graphics/threepoint-scheme}
  \caption{Three point averaging}
  \label{fig:3pt}
\end{figure}
%
\begin{figure}[ht]
  \includegraphics[scale=.12]{graphics/threepoint-interior}
...
%
\begin{figure}[ht]
  \includegraphics[scale=.12]{graphics/threepoint-msg}
...
\begin{figure}[ht]
  \includegraphics[scale=.5]{graphics/sendrecv-right}
  \caption{An MPI Sendrecv call}
  \label{fig:sendrecv}
\end{figure}

\begin{figure}[ht]
  \includegraphics[scale=.5]{graphics/sendrecv-steps}
...
\begin{figure}[ht]
  \includegraphics[scale=.3]{graphics/swapsort1}
...
\begin{figure}[ht]
  \includegraphics[scale=.3]{graphics/swapsort2}
