...
% Angel de Vicente 
%
% Master file of the book for the course "Programming Techniques" ("Técnicas de
% Programación"), part of the Master in Astrophysics by the ULL
%
%%%%%%%%%%%%%%%%%%%%%
%
% 18/08/2019 - Started first version. Templates and a lot of the material for MPI
%              come from Victor Eijkhout Parallel Computing Book
%              (https://bitbucket.org/VictorEijkhout/parallel-computing-book/src/default/) 
%
%%%%%%%%%%%%%%%%%%%%%

\documentclass[11pt,a4paper,twoside,openany]{boek3}

% To be able to include pages from other pdf's
\usepackage{pdfpages,hyperref}

% To be able to use patchcmd
\usepackage{etoolbox}
...
\fancyfoot[RO]{\thepage}
\fancyfoot[RE]{\footnotesize\sl Programming Techniques}
\begin{lulu}
\fancyfoot[RE]{\footnotesize\sl Programming Techniques}
\end{lulu}
\fancyfoot[LO]{\footnotesize\sl Ángel de Vicente}
...
\input macros/acromacs
\input macros/bookmacs
\input exmacs
\input tutmacs
\input macros/idxmacs
\input macros/listingmacs
...
\def\revdate{\escapechar-1\relax September 2019}
\begin{lulu}
\def\publicdraft{}
...
\title{Programming Techniques (Master in Astrophysics - ULL)}
...
\part{Naïve N-body solution with Fortran}

\CHAPTER{N-body problem formulation}{nbody.tex}
\CHAPTER{Basic Fortran for first N-body implementation}{basic-fortran.tex}

\part{N-body solution with Barnes-Hut algorithm}
\CHAPTER{Barnes-Hut algorithm}{barnes-hut.tex}
\CHAPTER{Intermediate Fortran for Barnes-Hut N-body implementation}{intermediate-fortran.tex}
\CHAPTER{Barnes-Hut code}{barnes-hut-code.tex}

\part{Barnes-Hut in parallel}

%% \part{MPI}
%% 

% The following, after a good review/reduction, should make a nice textbook
% stuff for our course.
...
\CHAPTER{Getting started with MPI}{mpi-slides}
\CHAPTER{MPI collective operations}{mpi-collectives}
\CHAPTER{Barnes-Hut code in parallel}{barnes-hut-mpi-code.tex}
...
\Level 0 {Solutions to exercises}
\APPENDIX{Exercises in section \ref{sec:basic-fortran-exercises}}{sol-basic-fortran}{sol-basic-fortran}
\APPENDIX{Exercises in section \ref{sec:recursion-exercises}}{sol-intermediate-fortran}{sol-intermediate-fortran}
\APPENDIX{Exercises in section \ref{sec:basic-mpi-exercises}}{sol-basic-mpi}{sol-basic-mpi}
\APPENDIX{Exercises in section \ref{sec:collective-mpi-exercises}}{sol-collective-mpi}{sol-collective-mpi}

\Level 0 {Barnes-Hut Algorithm}
\APPENDIX{Barnes-Hut original paper in Nature}{nature-nbody}{nature-nbody}
...
\SetBaseLevel 0
\PROJECT{Project A - Genealogy project (pointers and recursion)}{genealogy}
\PROJECT{Project B - RT-like (MPI)}{rt-like}
